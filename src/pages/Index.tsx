...
const Index = () => {
  ...
  return <div className="min-h-screen overflow-hidden py-[10px]">
      <Header />
      <main>
        <WhySection />
        <HowSection />
      ...
      <div className="fixed bottom-0 left-0 w-full bg-arw-navy text-white py-3 px-6 z-40 flex justify-between items-center">
        ...
        <div className="ml-4 flex items-center">
          <a href="#booking" className="text-xs md:text-sm bg-arw-blue hover:bg-opacity-90 text-white py-1 rounded px-[18px]">
