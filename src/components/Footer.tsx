...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    services: [
      ...
      { name: 'Insulation Services', href: '/services/insulation-services' },
      { name: 'Gutter Systems', href: '/services/gutter-systems' },
    ],
    locations: [
      { name: 'Brisbane Roofing', href: '/services/brisbane-roofing' },
      { name: 'Gold Coast Roofing', href: '/services/gold-coast-roofing' },
      { name: 'Sunshine Coast Roofing', href: '/services/sunshine-coast-roofing' },
    ],
    projects: [
    ...
    resources: [
      { name: 'Roof Report', href: '/roof-report' },
      { name: 'Job Uploads', href: '/job-uploads' },
  ...
  return (
    <footer className="bg-arw-navy text-white">
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-7 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              ARW Construction is a leading Australian construction company specializing in 
              premium roofing solutions and comprehensive construction services. We deliver 
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-300 text-sm mb-4 md:mb-0">
            © {currentYear} ARW Construction. All rights reserved.
          </div>
