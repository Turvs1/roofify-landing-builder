...
const HowSection = () => {
  ...
  return <section id="how" className="py-12 bg-gray-50 relative overflow-hidden">
      ...
      <div className="section-container relative\n">
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          {deliveryItems.map((item, index) => <AnimatedSection key={index} delay={item.delay} className="mb-6">
