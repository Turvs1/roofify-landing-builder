...
const Header = () => {
  ...
  return <header className="relative w-full h-screen py-[20px]">
      {/* Navigation */}
      <nav className="px-0 bg-slate-50 py-0">
        <div className="max-w-7xl mx-auto flex justify-between items-center py-0 px-[25px] my-[17px]">
          ...
          <div className="hidden md:flex space-x-8 z-10">
            <button onClick={() => scrollToSection('why')} className="">
              Why
            </button>
            <button onClick={() => scrollToSection('how')} className="">
              How
            </button>
            <button onClick={() => scrollToSection('what')} className="">
              What
            </button>
